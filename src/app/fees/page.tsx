...
export const metadata: Metadata = {
  title: "Fees & Funding",
  description:
    "Transparent childcare fees at Spring Lane Nursery Croydon. Full day from £72, half day from £43, with per-room pricing across Blossom, Sunshine and Rainbow rooms. Government funding accepted: 15-hour and 30-hour schemes. Breakfast club and after hours available.",
  openGraph: {
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description: "Full day care in the Blossom Room from 7:30am to 6:00pm",
        },
        price: "82.00",
        priceCurrency: "GBP",
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description: "Full day care in the Sunshine Room from 7:30am to 6:00pm",
        },
        price: "78.00",
        priceCurrency: "GBP",
        availability: "https://schema.org/InStock",
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description: "Full day care in the Rainbow Room from 7:30am to 6:00pm",
        },
        price: "72.00",
        priceCurrency: "GBP",
        availability: "https://schema.org/InStock",
